...
- **翻訳言語**: 英語→日本語のみ対応
- **料金**: chatgpt4o miniを使用して20万字翻訳して17.71円でした。
...
翻訳自体はMODと変わりませんが、SNBTファイルを翻訳キーを適用したものに置き換えないと、リソースパックを導入しても翻訳が反映されません。
そのため、FTB Questsを翻訳する場合は、「SNBT適用」ボタンでSNBTファイルを変換を実行してください。
