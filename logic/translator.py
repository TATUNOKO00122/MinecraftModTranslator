...
class TranslatorThread(QThread):
    ...
    def translate_batch(self, items):
        ...
        system_content = (
            ...
            "3. MOST IMPORTANT - TRANSLATE ALL ENGLISH TEXT:\n"
            "   - '&eequipment&r' → '&e装備&r' (translate 'equipment')\n"
            "   - '&eEverbright&r' → '&eエバーブライト&r' (translate proper nouns phonetically)\n"
            "   - 'Gear Stat Souls' → 'ギアステータスソウル' (translate game terms)\n"
            "   - ALL English words MUST be translated to Japanese, including:\n"
            "     * Item names, equipment names\n"
            "     * Location names, dimension names\n"
            "     * Skill names, ability names\n"
            "     * Status effect names\n"
            "   - Use katakana (カタカナ) for proper nouns and foreign words.\n"
